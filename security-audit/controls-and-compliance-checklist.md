...
Not a single control, but multiple controls at Botium Toys should be implemented to achieve a better security posture and confidentiality of sensitive information. Password policies, a password management system, separation of duties, disaster recovery plans, least privilege, and an IDS should all be implemented for the overall betterment of security in the organization.
